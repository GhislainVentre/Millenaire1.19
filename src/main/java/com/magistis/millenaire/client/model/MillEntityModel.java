...
package com.magistis.millenaire.client.model;
...
public class MillEntityModel extends EntityModel<MillEntity> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Millenaire.MOD_ID, "example_entity"), "main");

	private final ModelPart body;

	public MillEntityModel(ModelPart root) {
	...
	@Override
	public void setupAnim(MillEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {}
